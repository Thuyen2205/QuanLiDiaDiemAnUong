...
class Follow(models.Model):
    nguoi_dung=models.ForeignKey(TaiKhoan,on_delete=models.CASCADE,null=False, blank=False,related_name='nguoi_dung_follow')
    cua_hang=models.ForeignKey(TaiKhoan,on_delete=models.CASCADE,null=False, blank=False,related_name='cua_hang_follow')
...
class DanhGia(models.Model):
    nguoi_dung=models.ForeignKey(TaiKhoan,on_delete=models.CASCADE,null=False,blank=False,related_name='nguoi_dung_danh_gia')
    cua_hang=models.ForeignKey(TaiKhoan,on_delete=models.CASCADE,null=True,blank=True,related_name='cua_hang_danh_gia')
